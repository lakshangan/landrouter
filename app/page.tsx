      ...
      <div className="px-8 mx-auto text-center">
        ...
        <p className="text-white/60 text-lg max-w-xl mx-auto">
          ...
          >
					...
					Land Vault is an innovative project that allows users to own fractional shares of land as NFTs. This empowers you to invest in real estate with ease, leveraging blockchain technology for seamless transactions..
        </p>
